...
def display_home():
    ...
    st.header("Problem")
    st.write("Hypertensive Retinopathy (HR) is a rare eye condition caused by high blood pressure damaging the retina, potentially leading to irreversible blindness if not diagnosed and treated early. Diagnosing HR is challenging due to the lack of efficient and accurate diagnostic tools, hindering early detection and effective treatment. The American Academy of Ophthalmology reports that 2-17% of people with hypertension, translating to 22.6 million to 198.88 million globally, could develop HR. This corresponds to approximately 0.283%-2.486% of the world's population. \n Manual detection of HR involves analyzing fundus images, a time-consuming and error-prone process, especially in early stages where symptoms are subtle. Often, HR signs develop late, making timely detection critical for effective intervention. However, human limitations in identifying early symptoms can lead to inaccurate and delayed diagnoses, allowing the disease to progress and reducing treatment efficacy. The time-intensive nature of image examination necessitates multiple consultations and comparisons, causing delays and increased workload for doctors. In low-resource areas, lack of awareness and specialist availability further exacerbate undiagnosed and untreated cases, highlighting the scarcity of screening resources.")
